...
import com.dicoding.finalsubmission1.FinishedFragment
...
class FinishAdapter(private val events: List<ListEventsItem>, private val fragment: FinishedFragment) :
    RecyclerView.Adapter<FinishAdapter.EventViewHolder>() {
