...
import com.dicoding.finalsubmission1.api.EventApiService
...
import com.dicoding.finalsubmission1.databinding.ActivityDetailBinding
...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (isConnectedToInternet()) {
            ...
            binding.eventLink.visibility = View.VISIBLE
        } else {
            binding.fabFavorite.visibility = View.GONE
            binding.eventLink.visibility = View.GONE
